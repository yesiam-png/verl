...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="/mnt/task_runtime")
...
#            system_prompt = "After each <eol>, either provide a concise comment explaining the purpose and logic of the upcoming section of code, OR directly skip to the next line."
    ...
    for i in range(1):  # 256
        input_parquet = f"s3://afm-common-permanent/shenao_zhang/opencoder.parquet"
        ...
        train_dataset.to_parquet(os.path.join(local_dir, f"opencoder_post.parquet"))
